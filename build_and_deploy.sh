...
echo "gsutil rm gs://${bucket}/pic-crop.jpg"
gsutil rm gs://${bucket}/pic-crop.jpg
...
URL=${URL}"?url=https://storage.googleapis.com/app-imm-bucket-in/amit-profile-pic.jpg&top=300&right=352&left=760&bottom=1100"
